;;; hemisu-dark-theme.el --- Hemisu for Emacs.
...
(defun create-hemisu-dark-theme (variant theme-name &optional childtheme)
  (let* (
     (black              "#000000")
     (white              "#FFFFFF")
     (almost-white       "#EEEEEE")
...
(deftheme hemisu-dark "hemisu dark colour theme")
(create-hemisu-dark-theme 'dark 'hemisu-dark)
(provide-theme 'hemisu-dark)

;; Local Variables:
;; no-byte-compile: t
;; End:
(provide 'hemisu-dark-theme)
